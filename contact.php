...
include('include/header_contact.php');
        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">C-209 Parichay CHSL, Vidya Mandir RD, Dahisar(E),Mumbai-68</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">9324810612</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">vedantmehta25001@gmail.com</a></p>
